            ...
            >
                <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }} className="px-8">
                    <View className="mb-12">
                        <Text className="text-5xl font-extrabold text-slate-900 mb-2">Create Account</Text>
                        <Text className="text-xl text-slate-500">Join TaskMate and get started.</Text>
                    </View>
                    ...
                    <View className="space-y-4">
                        ...
                        >
                            {loading ? (
                                ...
                                <Text className="text-white font-extrabold text-2xl">Sign Up</Text>
                            )}
                        </TouchableOpacity>
                        ...
                        >
                            <Text className="text-slate-500 text-lg">
                                Already have an account? <Text className="text-blue-600 font-bold">Log in instead</Text>
                            </Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
